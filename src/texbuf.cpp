...
void MyApp::initGraphicsPipeline() {
    auto vertShaderCode = readFile("texbuf.vert.spv");
    auto fragShaderCode = readFile("texbuf.frag.spv");
...
VkImageView MyApp::createImageView(VkImage image, VkFormat format) {
